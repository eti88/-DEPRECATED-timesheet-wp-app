...
*/
        ...
        private async void DeleteAllActivity_Click(object sender, RoutedEventArgs e)
        {
            string msg;
            string btnSubmit;
            string btnCacel;
            ...
            {
                msg = "Sei veramente sicuro di voler eliminare tutte le tue attività?";
                btnSubmit = "Si";
                btnCacel = "No";
            ...
            {
                msg = "Are you sure you want to delete all of your activities?";
                btnSubmit = "Yes";
                btnCacel = "No";
            }

            MessageDialog msgBox = new MessageDialog(msg);
            msgBox.Commands.Add(new UICommand(btnSubmit, new UICommandInvokedHandler(CommandHandlers)));
            msgBox.Commands.Add(new UICommand(btnCacel, new UICommandInvokedHandler(CommandHandlers)));
        ...
        private void OnToogle_LiveTile(object sender, RoutedEventArgs e)
        {
        ...
        private void LoadSettings()
        {
            ...
            {
                ToogleTile.IsOn = (bool)settings.Values["liveTile"];
            }
        }
