...
namespace timesheet.View
{
    ...
    /// </summary>
    public sealed partial class QueryActivitiesList : Page
    {
        private NavigationHelper navigationHelper;
        private ObservableDictionary defaultViewModel = new ObservableDictionary();
        TimeActivitiesVMQueryList vm = new TimeActivitiesVMQueryList();
        private String startDate;
        private String endDate;

        public QueryActivitiesList()
        {
        ...
        private async Task List_refresh(object sender, EventArgs e)
        {
            if (vm.Activities != null && vm.Activities.Count > 0)
            {
                vm.Activities.Clear();
            }
            ...
            {
                vm.GetQueryList(startDate, endDate);
            }

            var items = vm.Activities;
        ...
        private void ItemList_Load(object sender, RoutedEventArgs e) {
